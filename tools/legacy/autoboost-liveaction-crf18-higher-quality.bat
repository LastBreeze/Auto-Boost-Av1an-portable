...
set "FAST_PARAMS=--ac-bias 1.2 --hbd-mds 0 --keyint 305 --tune 3 --filtering-noise-detection 1"
set "FINAL_PARAMS=--ac-bias 1.2 --hbd-mds 1 --keyint 305 --tune 3 --filtering-noise-detection 1 --lp 3 --photon-noise 200"
set "FINAL_SPEED=4"
set "QUALITY=18"
