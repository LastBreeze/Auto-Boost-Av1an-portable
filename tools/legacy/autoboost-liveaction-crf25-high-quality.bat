...
set "FAST_PARAMS=--ac-bias 1.0 --hbd-mds 0 --keyint 305 --tune 3 --filtering-noise-detection 4"
set "FINAL_PARAMS=--ac-bias 1.0 --hbd-mds 1 --keyint 305 --tune 3 --filtering-noise-detection 4 --lp 3 --photon-noise 200"
set "FINAL_SPEED=4"
set "QUALITY=25"
