...
set "FAST_PARAMS=--ac-bias 0.6 --sharp-tx 0 --sharpness 1 --tf-strength 3 --keyint 305 --variance-boost-strength 1 --variance-octile 7 --enable-dlf 2 --tune 3"
set "FINAL_PARAMS=--ac-bias 0.6 --sharp-tx 0 --sharpness 1 --tf-strength 3 --keyint 305 --variance-boost-strength 1 --variance-octile 7 --enable-dlf 2 --tune 3 --lp 3 --photon-noise 200"
set "FINAL_SPEED=4"
set "QUALITY=33"
