...
class _Plugin_lsmas_Core_Bound(Plugin):
    ...
    def LWLibavSource(self, source: DataType, stream_index: Optional[int] = None, cache: Optional[int] = None, cachefile: Optional[DataType] = None, threads: Optional[int] = None, seek_mode: Optional[int] = None, seek_threshold: Optional[int] = None, dr: Optional[int] = None, fpsnum: Optional[int] = None, fpsden: Optional[int] = None, variable: Optional[int] = None, format: Optional[DataType] = None, decoder: Optional[DataType] = None, prefer_hw: Optional[int] = None, repeat: Optional[int] = None, dominance: Optional[int] = None, ff_loglevel: Optional[int] = None, cachedir: Optional[DataType] = None, ff_options: Optional[DataType] = None, rap_verification: Optional[int] = None) -> 'VideoNode': ...
...
# implementation: vship

class _Plugin_vship_Core_Bound(Plugin):
    """This class implements the module definitions for the "vship" VapourSynth plugin.\n\n*This class cannot be imported.*"""
    def BUTTERAUGLI(self, reference: 'VideoNode', distorted: 'VideoNode', qnorm: Optional[int] = None, intensity_multiplier: Optional[float] = None, distmap: Optional[int] = None, numStream: Optional[int] = None, gpu_id: Optional[int] = None) -> 'VideoNode': ...
    def CVVDP(self, reference: 'VideoNode', distorted: 'VideoNode', model_name: Optional[DataType] = None, model_config_json: Optional[DataType] = None, resizeToDisplay: Optional[int] = None, distmap: Optional[int] = None, gpu_id: Optional[int] = None) -> 'VideoNode': ...
    def GpuInfo(self, gpu_id: Optional[int] = None) -> DataType: ...
    def SSIMULACRA2(self, reference: 'VideoNode', distorted: 'VideoNode', numStream: Optional[int] = None, gpu_id: Optional[int] = None) -> 'VideoNode': ...

class _Plugin_vship_VideoNode_Bound(Plugin):
    """This class implements the module definitions for the "vship" VapourSynth plugin.\n\n*This class cannot be imported.*"""
    def BUTTERAUGLI(self, distorted: 'VideoNode', qnorm: Optional[int] = None, intensity_multiplier: Optional[float] = None, distmap: Optional[int] = None, numStream: Optional[int] = None, gpu_id: Optional[int] = None) -> 'VideoNode': ...
    def CVVDP(self, distorted: 'VideoNode', model_name: Optional[DataType] = None, model_config_json: Optional[DataType] = None, resizeToDisplay: Optional[int] = None, distmap: Optional[int] = None, gpu_id: Optional[int] = None) -> 'VideoNode': ...
    def SSIMULACRA2(self, distorted: 'VideoNode', numStream: Optional[int] = None, gpu_id: Optional[int] = None) -> 'VideoNode': ...
...
class _Plugin_vszip_Core_Bound(Plugin):
    ...
    def ColorMap(self, clip: 'VideoNode', color: Optional[int] = None) -> 'VideoNode': ...
    def CombMask(self, clip: 'VideoNode', cthresh: Optional[int] = None, mthresh: Optional[int] = None, expand: Optional[int] = None, metric: Optional[int] = None) -> 'VideoNode': ...
    def CombMaskMT(self, clip: 'VideoNode', thY1: Optional[int] = None, thY2: Optional[int] = None) -> 'VideoNode': ...
    def Deband(self, clip: 'VideoNode', range: Optional[int] = None, thr: Optional[SingleAndSequence[float]] = None, grain: Optional[SingleAndSequence[float]] = None, sample_mode: Optional[int] = None, seed: Optional[int] = None, blur_first: Optional[int] = None, dynamic_grain: Optional[int] = None, keep_tv_range: Optional[int] = None, random_algo_ref: Optional[int] = None, random_algo_grain: Optional[int] = None, random_param_ref: Optional[float] = None, random_param_grain: Optional[float] = None, thr1: Optional[SingleAndSequence[float]] = None, thr2: Optional[SingleAndSequence[float]] = None, angle_boost: Optional[float] = None, max_angle: Optional[float] = None) -> 'VideoNode': ...
    def ImageRead(self, path: SingleAndSequence[DataType], validate: Optional[int] = None) -> 'VideoNode': ...
    def Limiter(self, clip: 'VideoNode', min: Optional[SingleAndSequence[float]] = None, max: Optional[SingleAndSequence[float]] = None, tv_range: Optional[int] = None, mask: Optional[int] = None, planes: Optional[SingleAndSequence[int]] = None) -> 'VideoNode': ...
    def LimitFilter(self, flt: 'VideoNode', src: 'VideoNode', ref: Optional['VideoNode'] = None, dark_thr: Optional[SingleAndSequence[float]] = None, bright_thr: Optional[SingleAndSequence[float]] = None, elast: Optional[SingleAndSequence[float]] = None, planes: Optional[SingleAndSequence[int]] = None) -> 'VideoNode': ...
    ...
    def XPSNR(self, reference: 'VideoNode', distorted: 'VideoNode', temporal: Optional[int] = None, verbose: Optional[int] = None) -> 'VideoNode': ...
...
class _Plugin_vszip_VideoNode_Bound(Plugin):
    ...
    def ColorMap(self, color: Optional[int] = None) -> 'VideoNode': ...
    def CombMask(self, cthresh: Optional[int] = None, mthresh: Optional[int] = None, expand: Optional[int] = None, metric: Optional[int] = None) -> 'VideoNode': ...
    def CombMaskMT(self, thY1: Optional[int] = None, thY2: Optional[int] = None) -> 'VideoNode': ...
    def Deband(self, range: Optional[int] = None, thr: Optional[SingleAndSequence[float]] = None, grain: Optional[SingleAndSequence[float]] = None, sample_mode: Optional[int] = None, seed: Optional[int] = None, blur_first: Optional[int] = None, dynamic_grain: Optional[int] = None, keep_tv_range: Optional[int] = None, random_algo_ref: Optional[int] = None, random_algo_grain: Optional[int] = None, random_param_ref: Optional[float] = None, random_param_grain: Optional[float] = None, thr1: Optional[SingleAndSequence[float]] = None, thr2: Optional[SingleAndSequence[float]] = None, angle_boost: Optional[float] = None, max_angle: Optional[float] = None) -> 'VideoNode': ...
    def Limiter(self, min: Optional[SingleAndSequence[float]] = None, max: Optional[SingleAndSequence[float]] = None, tv_range: Optional[int] = None, mask: Optional[int] = None, planes: Optional[SingleAndSequence[int]] = None) -> 'VideoNode': ...
    def LimitFilter(self, src: 'VideoNode', ref: Optional['VideoNode'] = None, dark_thr: Optional[SingleAndSequence[float]] = None, bright_thr: Optional[SingleAndSequence[float]] = None, elast: Optional[SingleAndSequence[float]] = None, planes: Optional[SingleAndSequence[int]] = None) -> 'VideoNode': ...
    ...
    def XPSNR(self, distorted: 'VideoNode', temporal: Optional[int] = None, verbose: Optional[int] = None) -> 'VideoNode': ...
...
class VideoNode(RawNode):
    ...
    def text(self) -> _Plugin_text_VideoNode_Bound:
        """VapourSynth Text"""
    # end instance
    # instance_bound_VideoNode: vship
    @property
    def vship(self) -> _Plugin_vship_VideoNode_Bound:
        """VapourSynth SSIMULACRA2 on GPU"""
    # end instance
...
class Core:
    ...
    def text(self) -> _Plugin_text_Core_Bound:
        """VapourSynth Text"""
    # end instance
    # instance_bound_Core: vship
    @property
    def vship(self) -> _Plugin_vship_Core_Bound:
        """VapourSynth SSIMULACRA2 on GPU"""
    # end instance
