...
"VapourSynth\python.exe" "tools\av1an-dispatch.py" --resume --fork %fork% --arch %ARCH% --denoise %DENOISE% --autocrop --crf %CRF% --workers %WORKER_COUNT% --final-speed %FINAL_SPEED% --final-params "%av1an_settings%"
