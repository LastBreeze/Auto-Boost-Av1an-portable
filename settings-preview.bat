...
:: video-input, and opens vspreview with the untouched source and the filtered
:: result side by side.
...
echo.
echo In vspreview, press 1 for the source and 2 for the filtered version. If crop or
...
echo Ctrl+mousewheel zooms in. Close the vspreview window when you are done.
echo.
